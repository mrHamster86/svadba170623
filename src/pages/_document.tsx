  ...
  return (
    <Html lang="ru">
      <Head>
        ...
        <meta property="og:site_name" content="Приглашаем вас на нашу свадьбу" />
        <meta property="og:title" content="Будем радоваться вместе с вами в наш счастливый день! Ждем вас 17 июня!" />
